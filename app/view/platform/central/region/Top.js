...
Ext.define('app.view.platform.central.region.Top', {
  ...
  requires : ['expand.ux.ButtonTransparent', 'app.view.platform.central.menu.ButtonMainMenu', 'Ext.toolbar.Spacer',
      ...
      'app.view.platform.central.widget.PopupMessageButton', 'app.view.platform.central.widget.ThemeSelect',
      'app.view.platform.central.widget.DataFilterSelectButton'],
  defaults : {
  ...
  initComponent : function() {
    ...
    this.items = [{
        ...
        }, !cfg.systeminfo.disableActiviti ? {
          xtype : 'hintmessagebutton'
        } : null, ' ', !cfg.systeminfo.disablePopupWindow ? {
          xtype : 'popupmessagebutton'
        } : null, ' ', {
          ...
          xtype : 'userfavicon'
        }, ' ', !cfg.systeminfo.disableThemeSelect ? {
          xtype : 'themeselect'
        } : null, ' ', {
          tooltip : '注销',
          iconCls : 'x-fa fa-sign-out',

Ext.define('app.view.platform.datamining.toolbar.SchemeToolbarController', {
  ...
  // 显示或隐藏可以编辑列分组的区域
  onToggleColumnPanel : function(button, pressed) {
    var me = this;
    columnpanel = me.lookup('columngroupdefine');
    if (pressed) {
      columnpanel.setStyle("visibility", "visible");
      columnpanel.setWidth(350);
    } else {
      columnpanel.setStyle("visibility", "hidden");
      columnpanel.setWidth(0);
    }
  },
  // 在主区域中显示明细列表

Ext.define('app.view.platform.login.LoginController', {
  ...
  validate: function (invalidate) {
    ...
    userinfo.password = window.sm4.encrypt(userinfo.password, this.reverse(cfg.loginsettinginfo.loginslatkey));
  ...
  pin: function (userinfo) {
    ...
    if (ui.password) {
      ui.slatkey = cfg.loginsettinginfo.loginslatkey;
  ...
  pout: function (userinfo) {
    ...
    if (ui.password) {
      ...
      ui.password = window.sm4.decrypt(ui.password, this.reverse(ui.slatkey));
    }
    return ui;
  },

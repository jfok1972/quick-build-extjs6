 ...
 */
Ext.define('app.view.platform.module.sqlparam.StartEndDateSelectMenuController', {
	  extend : 'Ext.app.ViewController',
	  alias : 'controller.startenddateselectmenu',
			    ...
			    'form button#absolutebutton' : {
				    click : function(button){
					    ...
					    if (form.itemId != 'datesection') {
						    firstyearfield = form.down('[name=firstyear]');
						    lastyearfield = form.down('[name=lastyear]');
					    ...
					    switch (form.itemId) {
						    ...
						    case 'monthsection' :
							    firstmonth = form.down('[name=firstmonth]').getValue();
							    lastmonth = form.down('[name=lastmonth]').getValue();
							    ...
							    break;
						    case 'quartersection' :
							    firstquarter = form.down('[name=firstquarter]').getValue();
							    lastquarter = form.down('[name=lastquarter]').getValue();
							    if (firstyearfield.disabled || lastyearfield.disabled) {
								    if (!firstyearfield.disabled) { // lastyear 不可用

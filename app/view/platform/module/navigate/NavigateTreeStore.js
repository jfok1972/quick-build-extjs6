...
Ext.define('app.view.platform.module.navigate.NavigateTreeStore', {
  ...
  listeners : {
    ...
    beforeload : function(store) {
      ...
      if (me.tree.moduleInfo.fDataobject.hassqlstatement){
    	  me.proxy.extraParams.sqlparamstr = 
    		  Ext.encode( me.tree.up('modulenavigate').modulePanel.down('modulesqlform').getSqlParam());
      }
    },
